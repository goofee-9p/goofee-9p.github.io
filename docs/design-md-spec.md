<!--
  Source: https://github.com/google-labs-code/design.md  (docs/spec.md, version: alpha)
  Fetched: 2026-06-02
  This is the official DESIGN.md format specification — the reference for HOW to read and
  write a DESIGN.md. This project's actual design tokens live in ../DESIGN.md.
-->
